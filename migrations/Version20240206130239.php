 ...
 */
final class Version20240206130239 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "table" (id INT NOT NULL, table_name VARCHAR(255) NOT NULL, owner VARCHAR(255) DEFAULT NULL, db_file_name VARCHAR(255) DEFAULT NULL, tab_id INT NOT NULL, row_size INT NOT NULL, number_rows INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, version INT NOT NULL, table_type VARCHAR(255) DEFAULT NULL, aud_path VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
